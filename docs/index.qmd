...
subtitle: "NUMBATs, Monash University"
date: "2024-10-24"
author: "Nicholas Tierney, Michael Lydeamore, Nick Golding, Chitra Saraswati, Aarathy Babu"
institute: The Kids Research Institute
format: 
  revealjs:
    ...
    footer: "njtierney.github.io/conmat-numbat-2024/"
    chalkboard:
      boardmarker-width: 5
      buttons: true
editor: visual
...
-   **2018 - 2020**: Research Fellow / Lecturer \@ Monash
    ...
    -   Design and improve tools for EDA with [Di Cook](https://www.dicook.org/)
...
- 2023
  - May - October: Hiked the [Pacific Crest Trail](https://en.wikipedia.org/wiki/Pacific_Crest_Trail)
...
```{r}
monash_perth <- combine_abs_two_age_distributions(
     lga_1 = "Monash (C)",
     lga_2 = "Perth (C)"
)

plot_two_abs_distributions(monash_perth)
```
...
```{r}
mat_diff <- synthetic_polymod_oz$home - synthetic_monash$home
autoplot(mat_diff) + 
...
`r icon_bullhorn` [njtierney.github.io/conmat-numbat-2024](njtierney.github.io/conmat-numbat-2024)
...
```{r}
#| label: apply-vaccination-monash
#| echo: true
